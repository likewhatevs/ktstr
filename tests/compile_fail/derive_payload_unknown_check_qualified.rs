// A MetricCheck-prefixed constructor that isn't real also fails to
...
// something else.
use ktstr::Payload;
use ktstr::test_support::MetricCheck;

#[derive(Payload)]
#[payload(binary = "bad_qualified_check_bin")]
#[default_check(MetricCheck::nonexistent_check("metric", 1.0))]
#[allow(dead_code)]
