...
2. **Guest process** -- the same test binary running inside the VM
   ...
   writes results to virtio-console port 1. Panics, crashes, and
   other non-blockable diagnostics fall back to COM2.
...
non-blockable diagnostics fall back to COM2.
