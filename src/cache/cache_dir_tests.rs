...
fn kconfig_status_matches_when_hash_equal() {
    ...
    let src_dir = TempDir::new().unwrap();
    let image = create_fake_image(src_dir.path());
    let meta = test_metadata("6.14.2").with_ktstr_kconfig_hash("deadbeef");
    let entry = cache
...
fn kconfig_status_stale_pins_cached_and_current_field_order() {
    ...
    let src_dir = TempDir::new().unwrap();
    let image = create_fake_image(src_dir.path());
    let meta = test_metadata("6.14.2").with_ktstr_kconfig_hash("old_cached");
    let entry = cache
...
fn kconfig_status_empty_strings_classify_as_matches() {
    ...
    let src_dir = TempDir::new().unwrap();
    let image = create_fake_image(src_dir.path());
    let meta = test_metadata("6.14.2").with_ktstr_kconfig_hash("");
    let entry = cache
