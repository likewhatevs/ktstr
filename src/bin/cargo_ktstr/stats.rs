...
fn run_stats_compare(args: CompareArgs<'_>) -> Result<(), String> {
    ...
    let build = BuildCompareFilters {
        ...
        shared_resolve_source: resolve_source.clone(),
        ...
        a_resolve_source: a_resolve_source.clone(),
        ...
        b_resolve_source: b_resolve_source.clone(),
...
pub(crate) struct BuildCompareFilters {
    ...
    pub(crate) a_resolve_source: Vec<String>,
    ...
    pub(crate) b_resolve_source: Vec<String>,
...
impl BuildCompareFilters {
    ...
    pub(crate) fn build(&self) -> (ktstr::cli::RowFilter, ktstr::cli::RowFilter) {
        ...
        let filter_a = ktstr::cli::RowFilter {
            ...
            resolve_sources: pick_vec(&self.a_resolve_source, &self.shared_resolve_source),
        ...
        let filter_b = ktstr::cli::RowFilter {
            ...
            resolve_sources: pick_vec(&self.b_resolve_source, &self.shared_resolve_source),
