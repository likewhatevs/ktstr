...
fn write_show<W: std::fmt::Write>(
    ...
    write_show_host_pressure(w, &display_options, snap)?;

    write_show_smaps(w, &display_options, snap, no_thread_normalize)?;

    write_show_sched_ext(w, &display_options, snap)?;
...
/// and show.
#[allow(clippy::too_many_arguments)]
fn write_show_primary<W: std::fmt::Write>(
    w: &mut W,
...
#[allow(clippy::too_many_arguments)]
fn write_show_derived<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    groups: &std::collections::BTreeMap<String, ctprof_compare::ThreadGroup>,
    group_order: &[&String],
...
/// the snapshot.
fn write_show_cgroup_sections<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    snap: &ktstr::ctprof::CtprofSnapshot,
    group_by: ctprof_compare::GroupBy,
...
fn write_show_cgroup_stats_table<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
...
fn write_show_cgroup_limits_table<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    stats: &std::collections::BTreeMap<String, ktstr::ctprof::CgroupStats>,
) -> std::fmt::Result {
...
fn write_show_memory_stat_table<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    stats: &std::collections::BTreeMap<String, ktstr::ctprof::CgroupStats>,
) -> std::fmt::Result {
...
/// suppression.
fn write_show_memory_events_table<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    stats: &std::collections::BTreeMap<String, ktstr::ctprof::CgroupStats>,
) -> std::fmt::Result {
...
fn write_show_cgroup_pressure_tables<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    stats: &std::collections::BTreeMap<String, ktstr::ctprof::CgroupStats>,
) -> std::fmt::Result {
...
fn write_show_host_pressure<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    snap: &ktstr::ctprof::CtprofSnapshot,
) -> std::fmt::Result {
...
fn write_show_smaps<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    snap: &ktstr::ctprof::CtprofSnapshot,
    no_thread_normalize: bool,
...
fn write_show_sched_ext<W: std::fmt::Write>(
    w: &mut W,
    display_options: &ctprof_compare::DisplayOptions,
    snap: &ktstr::ctprof::CtprofSnapshot,
) -> std::fmt::Result {
